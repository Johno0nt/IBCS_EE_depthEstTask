...
def main():
    img1 = cv2.imread("C:\\Users\\jngo1\\OneDrive - Department of Education and Training\\EE Work\\Code\\Depth-Estimation-using-Stereovision-main\\Dataset 1\\im0.png", 0)
    img2 = cv2.imread("C:\\Users\\jngo1\\OneDrive - Department of Education and Training\\EE Work\\Code\\Depth-Estimation-using-Stereovision-main\\Dataset 1\\im1.png", 0)
